					...
					<ul>
						...
						<li class="submenu-open">
							...
							<ul>
								<li class="submenu">
									...
									<ul>
										...
										<li><a href="<?=ROOT?>/StockAppros">Approvisionnement</a></li>
							...
							<ul>
								<li class="submenu">
									<a href="javascript:void(0);">
										<i data-feather="shopping-bag"></i><span>Commande article</span><span class="menu-arrow"></span>
									</a>
									<ul>
							...
							<ul>
								<li class="submenu">
									<a href="javascript:void(0);">
										<i data-feather="shopping-cart"></i><span>Vente article</span><span class="menu-arrow"></span>
									</a>
									<ul>
										<li><a href="<?=ROOT?>/Ventes/Liste_vente">Liste vente Engros</a></li>
										<li><a href="<?=ROOT?>/Ventes/Liste_vente">Liste vente Detaille</a></li>
