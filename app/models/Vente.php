    ...
    public function VenteEnregistrer($Data = [])
    {
        ...
        try {
            ...
            $createVente = $this->insertion_update_simples_insert_id(
                "INSERT INTO `vente`(`referenceVente`, `date`, `uuidClientFourniture`, `uuidBoutique`, `MontantPayer`, `MontantReste`, `montantTotal`) 
                 VALUES (:referenceVente, :date, :uuidClientFourniture, :uuidBoutique, :montantPayer, :montantReste, :montantTotal)",
                [
